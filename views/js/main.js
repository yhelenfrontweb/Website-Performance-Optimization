...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    ...
    var dx = determineDx(pizzaCon[1], size, windowwidth);
    var newwidth = (pizzaCon[1].offsetWidth + dx) + 'px';

    for (var p = 0; p < pizzaCon.length; p++) {
      pizzaCon[p].style.width = newwidth;
    }
  }
...
// Moved the pizzasDiv variable outside the for loop
...
function updatePositions() {
  ...
  // for loop is causing unnecessary recalculates of style & layout when scrolling
